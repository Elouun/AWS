...
getCloserRestaurants = 'select b.business_id, b.name, b.address, b.city, b.state, b.postal_code, b.latitude, b.longitude, b.stars, image_id, ST_Distance_Sphere(point(?long, ?lat),point(b.longitude,b.latitude)) as distance from Business b natural join image order by distance limit ?nb'
