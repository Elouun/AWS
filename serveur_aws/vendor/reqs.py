...
loca = 'select name, latitude, longitude from Business'
...
databusiness = ' SELECT name as name_resto , city as city_resto , latitude as lat , longitude as lng , Indian as indian , French as french , id_new as id, stars as stars FROM Business WHERE id_new IN (?n)' 
